        ...
        >
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/in/muhammadalifakhdan/" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-800/50 border border-slate-700 text-slate-300 hover:bg-[#0a66c2] hover:text-white hover:border-transparent hover:-translate-y-1 transition-all duration-300 text-xl">
                <FaLinkedin />
              </a>
              <a href="https://github.com/alifakhdan" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-800/50 border border-slate-700 text-slate-300 hover:bg-slate-700 hover:text-white hover:border-transparent hover:-translate-y-1 transition-all duration-300 text-xl">
                <FaGithub />
              </a>
              <a href="https://www.instagram.com/alifakhdann/" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-800/50 border border-slate-700 text-slate-300 hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-pink-500 hover:to-purple-600 hover:text-white hover:border-transparent hover:-translate-y-1 transition-all duration-300 text-xl">
                <FaInstagram />
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-slate-800/30 border border-slate-700/50 rounded-3xl p-8 md:p-10 shadow-2xl backdrop-blur-sm">
            ...
            {/* PERBAIKAN 1: Mengubah action dan method pada form */}
            <form 
              className="flex flex-col gap-6" 
              action="mailto:alifakhdan57@gmail.com" 
              method="POST" 
              encType="text/plain"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input 
                    type="text" 
                    id="name" 
                    name="Nama" // PERBAIKAN 2: Menambahkan name
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input 
                    type="email" 
                    id="email" 
                    name="Email" // PERBAIKAN 2: Menambahkan name
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  id="message" 
                  name="Pesan" // PERBAIKAN 2: Menambahkan name
                  rows="5"
                  required
